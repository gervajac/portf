...
import img from "../assets/gerva8.jpg";

const About = () => {
  return (
    <section className="section" id="about">
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-[400px]">
          {/* img */}
          <div className="flex-1  bg-contain bg-no-repeat max-h-auto mix-blend-lighten bg-top">
            <img src={img} alt="" className="rounded-full brightness-80"></img>
          </div>
          {/* text */}
